"use strict";
let world = ["karachi", "islamabad", "murree", "hunza valley", "china border"];
console.log("original order", world);
console.log("\n");
let copiedarray = [...world]; //to make a copy/clone of an original array
...
console.log("\n");
let copiedarray2 = [...copiedarray]; //to make a copy/clone of an original array
